...
# function to send puzzle completion data to the servera
...
# displays the home page of the program for new user
def _remote_Home():
  global servo_4, servo_5, servo_2 
  lcd.clear()
  label5.show()
...
#command for catch unit to initiate gripping
def _remote_Grip():
  global servo_4, servo_5, servo_2 
  servo_2.write_angle(180)


#command for catch unit to initiate release of the grips
def _remote_Release():
  global servo_4, servo_5, servo_2 
