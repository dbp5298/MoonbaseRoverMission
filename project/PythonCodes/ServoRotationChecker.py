...
# Purpose Details: Code for the servo units rotation checking
# Course: IST440W
# Author: Jaydev Zala, Dhruv Parekh
# Date Developed: 2/26/2022
# Revision: 1
...
# servo mode declaration (manual)
def modeManual():
  global servoOut, mode, servoStep
  servo0.write_angle(servoOut)
  wait(0.2)

# servo mode declaration (center)
def modeCenter():
  global servoOut, mode, servoStep
  servoOut = 90
  servo0.write_angle(servoOut)
